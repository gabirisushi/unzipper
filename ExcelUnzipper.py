...
'''
Generic function to delete all the files from a given directory based on matching pattern in excel file
'''
...
def main():
    ...
    # Get a list of all the file paths from specified directory
